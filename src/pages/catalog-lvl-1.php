...
<div class="gap-xl">
	<div class="container">
		<div class="gap-lg">
            <h1>Садово-парковая мебель Хоббика</h1>
        </div>
        <div class="card-list">
            <a class="card card-section" href="javascript:;">
